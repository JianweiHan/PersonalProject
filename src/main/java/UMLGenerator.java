...
public class UMLGenerator {
    public static void umlGenerator(String outputFileName,Collection<String> classStrUML, Collection<String> associationStrUML, Collection<String> extendStrUML, Collection<String> ballsocketStrUML) throws Exception {
